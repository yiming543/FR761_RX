...
void processLIN(void) {
  ...
  switch (cmd) {
  case SIGNAL:
# 128 "mcc_generated_files/LINDrivers/lin_app.c"
    if (tempRxData[0] == 0x24) {


      if ((tempRxData[1] & 0B10000000) == 0B10000000 || (tempRxData[1] & 0B01000000) == 0B01000000){
...
# 164 "mcc_generated_files/LINDrivers/lin_app.c"
      if (((tempRxData[2] & 0B01000000) == 0B01000000) &&
      ...
      if (((tempRxData[5] & 0B00100000) == 0B00100000) &&
          ((tempRxData[4] & 0B00000111) == 0B00000111)) {
        lampFlags.fPOS = 1;
      }else{
        lampFlags.fPOS = 0;
...
# 231 "mcc_generated_files/LINDrivers/lin_app.c"

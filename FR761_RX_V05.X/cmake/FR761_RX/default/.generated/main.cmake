...
if(FR761_RX_default_default_XC8_FILE_TYPE_objcopy_lss)
add_library(FR761_RX_default_default_XC8_objcopy_lss OBJECT ${FR761_RX_default_default_XC8_FILE_TYPE_objcopy_lss})
    FR761_RX_default_default_XC8_objcopy_lss_rule(FR761_RX_default_default_XC8_objcopy_lss)
    list(APPEND FR761_RX_default_library_list "$<TARGET_OBJECTS:FR761_RX_default_default_XC8_objcopy_lss>")

endif()


# Main target for this project
add_executable(FR761_RX_default_image_qVrovDUC ${FR761_RX_default_library_list})

set_target_properties(FR761_RX_default_image_qVrovDUC PROPERTIES
    OUTPUT_NAME "default"
    SUFFIX ".elf"
    ADDITIONAL_CLEAN_FILES "${output_extensions}"
    RUNTIME_OUTPUT_DIRECTORY "${FR761_RX_default_output_dir}")
target_link_libraries(FR761_RX_default_image_qVrovDUC PRIVATE ${FR761_RX_default_default_XC8_FILE_TYPE_link})
# Add the link options from the rule file.
FR761_RX_default_link_rule( FR761_RX_default_image_qVrovDUC)


#Add objcopy steps
FR761_RX_default_objcopy_lss_rule(FR761_RX_default_image_qVrovDUC)
